...
class StreetFlashChecker implements FiveCardsCheckerInterface
{
    /**
    ...
    {
        return PokerCombination::STREET_FLASH;
    }
    ...
    public function check(): bool
    {
        ...
        $flashChecker = new FlashChecker($this->fiveCards);

        if (!$flashChecker->check()) {
            $this->checked = false;
    ...
    public function printResult(): string
    {
        ...
        if ($this->maxRank == CardRank::ACE) {
            return $this->check() ? 'This is royale flash' : '';
        }

        return $this->check() ? 'This is street flash' : '';
    }
